...
namespace twitter_api.Migrations
{
    ...
    [Migration("20230830061411_add-msg")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("twitter_api.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("twitter_api.Models.Message", b =>
                {
                    b.HasOne("twitter_api.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId");

                    b.HasOne("twitter_api.Models.User", "Sender")
                        .WithMany()
